 ...
 * MediaPlayer
 *
 * Partie 4 du plan de croissance ("lecteur vidéo YouTube/TikTok") -
 ...
 * réhéberge aucune vidéo : le vendeur colle un lien YouTube ou TikTok
 * (products.external_video_url, migration 20260721000025), et ce
...
export const MediaPlayer: React.FC<MediaPlayerProps> = ({ url, mode = 'full', active = true, poster, className }) => {
  ...
  if (mode === 'hoverPreview') {
    ...
    const src = `${embedUrl}?autoplay=1&mute=1&controls=0&loop=1&playsinline=1&rel=0&modestbranding=1${

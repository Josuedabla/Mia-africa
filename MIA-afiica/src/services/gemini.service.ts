/**
 * Gemini AI Service (client-side) - now calls the gemini-listing Supabase
 * Edge Function instead of a Firebase callable. Same contract as before:
 * the secret Gemini key never leaves the server, and a daily quota per
 * user is enforced server-side.
 */

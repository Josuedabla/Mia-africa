/**
 * Supabase client - replaces src/lib/firebase.ts.
 *
 * One client for Auth, Postgres (via PostgREST), Storage, and Realtime.
 * No separate "db"/"auth"/"storage" exports like the Firebase version -
 * everything hangs off this single `supabase` instance, which is the

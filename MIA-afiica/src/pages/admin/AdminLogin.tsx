 ...
 * Firebase Email/Password authentication for admin dashboard
 */
    ...
    <div className="min-h-screen bg-gradient-to-br from-mia-green-600 to-mia-orange-600 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">Authentification Firebase sécurisée</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Entrez votre mot de passe Firebase"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-mia-green-600 focus:border-transparent"
              disabled={loading}
              required
            />
        ...
        <p className="text-center text-xs text-gray-500 mt-6">
          Accès réservé aux administrateurs MIA uniquement • Firebase Auth
        </p>
      </motion.div>
    </div>
  );

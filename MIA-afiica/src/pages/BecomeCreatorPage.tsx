...
export default function BecomeCreatorPage() {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16 text-center">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Devenez créateur MIA</h1>
      <p className="text-gray-600 mb-6">
        Partagez du contenu, gagnez des abonnés, et recevez des cadeaux de la communauté MIA. Activation immédiate.
      </p>

      {isCreator ? (
        <div className="flex items-center justify-center gap-2 text-mia-green-700 font-semibold">
          <CheckCircle2 size={20} /> Capacité créateur déjà active
        </div>
      ) : (
        <button

...
import { MessageCircle, Star, ChevronLeft, Grid, Heart, ShoppingBag, Users, BadgeCheck, CalendarDays, FileText, Share2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            {products.map((product) => (
              ...
              >
                <button
                  ...
                  className="absolute top-2 right-2 z-10 w-9 h-9 flex items-center justify-center rounded-full bg-white/90 text-gray-700 shadow hover:bg-white"
                >
                  <Share2 size={16} />
                </button>
                <ProductCard
      ...
      {shareProduct && (
        <ShareSheet
          ...
          productSlug={shareProduct.slug}
          productName={shareProduct.name}
          price={`${shareProduct.price?.toLocaleString('fr-FR')} XOF`}

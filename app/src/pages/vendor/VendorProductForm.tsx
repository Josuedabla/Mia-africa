...
import { createProduct, updateProduct } from '@/services/db.service';
...
export default function VendorProductForm() {
  ...
  const handleSave = async (status: 'draft' | 'active') => {
    ...
    if (trimmedVideoUrl && !parseVideoUrl(trimmedVideoUrl).platform) {
      setError("Le lien vidéo doit être un lien YouTube ou TikTok valide (ou laissez le champ vide).");
      return;
    }
    setSaving(true);
    setError(null);
          ...
          <section className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 space-y-3">
            ...
            <div className="pt-2 border-t border-gray-100">
              ...
              <input
                ...
                placeholder="https://www.youtube.com/watch?v=... ou https://www.tiktok.com/@compte/video/..."
                className="w-full border border-gray-300 rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-mia-green-500"
              />
              <p className="text-xs text-gray-400 mt-1">
                Affichée en survol dans le flux et en lecture sur la fiche produit. Laissez vide si vous n'avez pas de vidéo.
              </p>
            </div>
          </section>
